  ...
  return (
    <main className="flex flex-col items-center px-0 sm:px-0 pb-16">
      ...
      <div className="relative z-0 w-[100%] mx-auto overflow-hidden bg-yellow-200 -mt-28 sm:-mt-36">
        <picture>
          <source media="(max-width: 640px)" srcSet="/app-radar-banner-mobile.png" />
          <img
      ...
      <div className="w-full sm:max-w-[73rem] -mt-10 sm:-mt-14 px-4 relative z-10">
        <div className="bg-white dark:bg-gray-950 rounded-[40px] shadow-xl border border-black/5 p-6 sm:p-10">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-8 sm:mb-12">App Radar — UI Redesign (2022)</h1>
          <p className="text-sm sm:text-base text-gray-700 dark:text-white/70 mb-2"><strong>Client:</strong> <br></br> App Radar</p>
          <p className="text-sm sm:text-base text-gray-700 dark:text-white/70 mb-2"><strong>Duration:</strong> <br></br> 2 months</p>
          <p className="text-sm sm:text-base text-gray-700 dark:text-white/70 mb-2"><strong>Role:</strong> <br></br> UX/UI Designer</p>
        </header>
        ...
        <section className="mb-12">
          ...
          <p className="text-sm sm:text-base leading-relaxed text-gray-700 dark:text-white/70">
            Freelance redesign of App Radar’s B2B application with a focus on helping
            new signups reach product value faster through clearer onboarding, empty
            states, and actionable insights in the dashboard.
          </p>
        </section>
        ...
        <section className="mb-12 space-y-4">
          <h3 className="text-lg sm:text-xl font-semibold">Problem 2 — Users lacked guidance for ASO</h3>
          <p className="text-sm sm:text-base text-gray-700 dark:text-white/70">
            Users needed direction to add main keywords and competitors; without this,
            the product couldn’t generate meaningful ASO recommendations.
          </p>
          <h4 className="font-semibold">Solution</h4>
          <p className="text-sm sm:text-base text-gray-700 dark:text-white/70">
            Added dashboard widgets prompting users to add keywords and competitors,
            which unlock context-aware ASO suggestions inside the app.
          </p>
          {/* Images */}
          <div className="grid gap-6 sm:grid-cols-1">
            <div className="relative w-full aspect-[16/9] rounded-xl overflow-hidden">
          ...
          <p className="text-sm sm:text-base text-gray-700 dark:text-white/70">
          Once we know enough information about the app we can give our customers ASO suggestions in the app. This is how the ASO suggestions looks like. 
          </p>
          <div className="grid gap-6 sm:grid-cols-1">
        ...
        <section className="mb-12 space-y-4">
          ...
          <ul className="list-disc list-inside text-sm sm:text-base text-gray-700 dark:text-white/70 space-y-1 sm:space-y-2 break-words">
            <li>Keyword Insights — understand current ranking & traffic potential</li>
            <li>Keyword Opportunities — discover higher-value alternatives</li>
          </ul>
          {/* Images */}
          <div className="grid gap-6 sm:grid-cols-1">
