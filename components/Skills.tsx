...
const Skills = () => {
  ...
  return (
      <section className='flex flex-col justify-center items-center mr-10 ml-10 sm:mr-20 sm:ml-20 scroll-mt-28 mt-20' ref={ref} id='skills'>
          ...
          <div className="flex justify-center  mr-5 ml-5 sm:mr-20 sm:ml-20 flex-wrap gap-2 sm:gap-4 mb-10">
          ...
          {
          <ul  className='flex justify-center items-center mr-5 ml-5 sm:mr-20 sm:ml-20 flex-wrap gap-4'>
